...
const propertySeed = [
  {
    ...
    hoaFee: 182,
    propFeatures:
      "Appliances: laundry faciilities: washer/dryer hookup up only, heating and cooling: cooling: ceiling fans, refrigeration. Heating: electric heat, no pool, 2 carport parking spaces",
    image:
      "https://ap.rdcpix.com/13b9a276c388dfc0687fcef1acfc87e4l-m3084758060od-w1024_h768.jpg",
    listingLink:
      "https://www.realtor.com/realestateandhomes-detail/5635-E-Casper-Rd_Mesa_AZ_85205_M17393-80976?view=qv",
    propDetailSummary:
...
dbConn.on("connected", function () {
  ...
  ///db.Property.collection.deleteMany({});

  db.Property.collection.insertMany(propertySeed);
  db.User.collection.insertMany(userSeed);
});

const seedDB = async () => {
  // await db.Property.deleteMany({});
  await db.Property.collection.insertMany(propertySeed);
